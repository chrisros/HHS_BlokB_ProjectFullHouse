...
public class Toernooi_beheren extends javax.swing.JFrame {
    ...
    private void vulLijst() {
        try {
            ...
            while (result.next()) {
                ...
                item.description = result.getString("Naam");
    ...
    private void openToernooiAgenda() {
    ...
    private void gegevensLijst() {
        try {
            if (toernooiList.getSelectedValue() == null) {
                ...
                naamToernooiTxt.setText(selectedItem.description);
    ...
    private void initComponents() {
        ...
        getListbutton.setText("Haal toernooi namen op");
